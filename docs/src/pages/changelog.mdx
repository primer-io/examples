...
## v0.13.3 - Improved error handling (29-Jan-2026)

Refactored iframe request error handling and fixed circular errors

## v0.13.2 - Bug fixes on vault manager (27-Jan-2026)

Fixed 2 bugs with Google Pay vaulted item rendering and Paypal buttons rendering when vault manager is enabled

## v0.13.1 - Error logging (23-Jan-2026)
...
- **New `redirect` Options**: `returnUrl`, `forceRedirect`, `resumePaymentOnPopupClosure`
- **New Events**: `primer:dialog-open`, `primer:dialog-close`
- **`enabledPaymentMethods` Default Change**: Now defaults to all supported payment methods instead of just `PAYMENT_CARD`. If not specified, all SDK Core-supported payment methods will be enabled.

**Documentation:**

- [SDK Options Reference - Redirect Options](/sdk-reference/sdk-options-reference#redirect-options) - Complete configuration options and behavior details
- [Events & Callbacks Reference](/sdk-reference/events-callbacks) - Dialog events documentation
